...
const escrow_service_js_1 = require("../escrow/escrow.service.js");
...
const register = async (req, res) => {
    try {
        ...
        // we start by creatin wallet valut for the user
        const wallet = await escrow_service_js_1.WalletService.ensureWallet(user.id);
    ...
    try {
        ...
        if (!user) {
            return res
                .status(404)
                .json({
                message: "This email has not been registered yet. Go back and create the account first.",
            });
        }
