...
import { acceptProjectMember, createProjectMember, deleteProjectMember, getProjectMemberById, getProjectMembers, rejectProjectMember, updateProjectMember, } from "../controllers/project-member.controller";
...
router.post("/:id/accept", requiredAuth, requireRole("engineer", "admin"), acceptProjectMember);
router.post("/:id/reject", requiredAuth, requireRole("engineer", "admin"), rejectProjectMember);
