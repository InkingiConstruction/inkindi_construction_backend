...
const session_route_1 = __importDefault(require("./auth/session.route"));
const verification_route_1 = __importDefault(require("./auth/verification.route"));
...
const account_route_1 = __importDefault(require("./users/account.route"));
