...
router.get("/", requiredAuth, requireRole("client", "engineer", "supplier", "admin"), getPurchaseOrders);
router.get("/:id", requiredAuth, requireRole("client", "engineer", "supplier", "admin"), getPurchaseOrderById);
