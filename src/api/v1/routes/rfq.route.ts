...
router.get("/", requiredAuth, requireRole("client", "engineer", "supplier", "admin"), getRfqs);
router.get("/:id", requiredAuth, requireRole("client", "engineer", "supplier", "admin"), getRfqById);
