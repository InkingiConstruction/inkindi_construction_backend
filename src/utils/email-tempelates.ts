...
export const emailVerificationTemplate = (otp: string): EmailTemplate => ({
...
export const passwordResetTemplate = (otp: string): EmailTemplate => ({
...
export const signInOTPTemplate = (otp: string): EmailTemplate => ({
...
export const kycApprovedTemplate = (name: string): EmailTemplate => ({
